...
| --- | --- | --- | :--- | --- |
| 3/30, 4/1 | 1 | Course intro, dev setup<br/>C++ basics (function, loop, ifs, pointer, reference)<br/>TDD basics<br/>Homework submission walthrough | C++ ch {1}<br/>ch interlue {2}<br/>apendx A & B | [1](https://github.com/a-teaching-goose/2022-342-sprint-1) |
